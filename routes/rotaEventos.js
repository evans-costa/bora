...
router.post('/cadastroevento', multerUpload.single('file'), EventosController.criarEvento)


// Ir para a tela de edição e alterar ou excluir um Evento
router.get('/:id/editarevento', EventosController.telaEditarEvento)
router.put('/:id/editarevento', multerUpload.single('file'), EventosController.atualizarPorId)
